...
public class RichiesteAzienda extends AziendaSecurity {
    ...
    private void action_gestioneRichieste(Map data,long idStudente, long idAnnuncio, HttpServletRequest request, HttpServletResponse response) throws IOException, SecurityLayerException, TemplateManagerException, DataLayerException, DocumentException {
        
        
        Studente studente = new StudenteDAOImpl().getStudenteForPdf(idStudente);
        Annuncio annuncio = new AnnuncioDAOImpl().getAnnuncioByIdForPdf(idAnnuncio);
        ...
        switch (request.getParameter("action")) {
            ...
            case "accetta":
              ...
              //Genero il file da inserire nel DB
                ...
                String progettoFormativo = res.getFilledTemplate("downloadResoconto.ftl.html", request);
                ...
                new TirocinioDAOImpl().setProgettoFormativoDoc(pdfInputStream, nuovoTirocinio);
...
try {
            ...
            long idAnnuncio = SecurityLayer.issetInt(request.getParameter("idAnnuncio"));
                ...
                Logger.getLogger(RichiesteAzienda.class.getName()).log(Level.SEVERE, null, ex);
            } 
        } else {
